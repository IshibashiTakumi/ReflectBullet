...
// グローバル変数
//=============================================================================
CSound* CSound::Instance = NULL;	//インスタンス
...
CSound::CSound()
{
	...
	{
		{ "./data/BGM/title.wav", -1 },		// BGM0coin000
		{ "./data/BGM/game.wav", -1 },		// BGM0coin001
		{ "./data/BGM/result.wav", -1 },		// BGM0coin002
		{ "./data/SE/Choice.wav", 0},			// 選択
		{ "./data/SE/bullet.wav", 0 },			// 発射
		{ "./data/SE/Reflection.wav", 0 },		// 反射
	};

	for (int nCnt = 0; nCnt < SOUND_LABEL_MAX; nCnt++)
	{
		m_aParam[nCnt] = aParam[nCnt];
	}
}
